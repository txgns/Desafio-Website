  ...
  module Formatter
    class MyHtml
      ...
      def initialize(runtime, path_or_io, options)
        # acrescentado
        FileUtils.mkdir_p(ENV['REPORT_PATH'])
        # ------------
        ...
        @builder.div(:id => 'cucumber-header') do
          @builder.div(:id => 'label') do
            ...
            @builder.h1() do
              @builder.img(:id    => 'logo',
                           :style => 'display: block',
                           :src   => '../../../../features/support/custom_report/header/logo.png',
                           :alt   => 'ERRO AO CARREGAR O LOGO')
            end
            # --------
          end
      ...
      def feature_name(keyword, name)
        ...
        @builder.p(:class => 'feature_narrative') do
      ...
      def scenario_name(keyword, name, file_colon_line, source_indent)
        ...
        @builder.p(:class => 'scenario_narrative') do
          lines[1..-1].each do |line|
            @builder.text!(line.strip)
            @builder.br
          end
      ...
      def after_examples(examples)
        # acrescentado
        embed_print($prints_outlines.shift) while !$prints_outlines.empty?
        # ------------
        @builder << '</div>'
      end
      ...
      def examples_name(keyword, name)
        ...
        @builder.p(:class => 'examples_narrative') do
          lines[1..-1].each do |line|
            @builder.text!(line.strip)
            @builder.br
          end
      ...
      def after_steps(steps)
        ...
        # acrescentado
        embed_print($prints_steps.shift) while !$prints_steps.empty?
        # ------------
      end
      ...
      def inline_js_content
        ...
        function makeRed(element_id) {
          $('#'+element_id).css('background', '#ad1313');
          $('#'+element_id).css('color', '#FFFFFF');
        }
        function makeYellow(element_id) {
          $('#'+element_id).css('background', '#e8e300');
